...
public class SyncHelper 
{
	...
	final String baseName  = "synclog.db";

//	private static final String DATABASE_NAME = "synclog";
//	private static final String DATABASE_TABLE = "t_words";
//	private static final String DATABASE_NEW_TABLE = "n_words";
//	private static final int    DATABASE_VERSION = 1;
	...
	private SQLiteDatabase openDatabase()
	{
		...
		try
		{
			...
			if (!(new File(databaseFilename)).exists())
			{
				...
				InputStream is = myContext.getResources().openRawResource(R.raw.synclog);
	...
	public int doDelete(String table,String whereClause,String[] whereArgs)
	{
		return myDatabase.delete(table, whereClause, whereArgs);
	}
	
	public int doUpdate(String table, ContentValues values, String whereClause,String[] args)
	{
		return myDatabase.update(table, values, whereClause, args);
	}
